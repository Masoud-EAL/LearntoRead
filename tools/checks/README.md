...
| `register` | the level-check pool never draws on the elementary banks, a gap in a sentence may be tapped but never typed, no question asks the learner to subtract, a step serving a Stage A feature deals only what that feature names, a Stage A greeting is answered in a word or two, and a Stage A sign offers other signs as its wrong options | "The cook ___ a good look at the food on the stove"; "are two digit deduction questions needed for PLB?"; "spelling words like humid and necklace, PLB position words and cents dealt at PLA, quarter hours against whole hours, auxiliary verbs in Question Words"; a review against the PTA kit: "How old are you?" answered with "I am forty years old." credited as a one word greeting |
