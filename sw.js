...
const OPTIONAL = [
  // generated by tools/build-links.py — the short share addresses (/clock, /speaking).
  './all-games.html',
  './all-games',
  './alphabet.html',
  './alphabet',
  './beginner-build-word.html',
  './beginner-build-word',
  './beginner-listening.html',
  './beginner-listening',
  './beginner-sound-gap.html',
  './beginner-sound-gap',
  './beginner-tap-word.html',
  './beginner-tap-word',
  './body.html',
  './body',
  './clock.html',
  ...
  './dice.html',
  './dice',
  './elementary-build-word.html',
  './elementary-build-word',
  './elementary-listening.html',
  './elementary-listening',
  './elementary-sound-gap.html',
